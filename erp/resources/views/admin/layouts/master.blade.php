...
<head>
    ...
    <link rel="stylesheet" href="{{asset('dist-assets/css/plugins/toastr.css')}}" />
    <link rel="stylesheet" href="{{asset('dist-assets/css/plugins/dataall.min.css')}}"/>
...
<body class="text-left">
    ...
    <script src="{{asset('dist-assets/js/myscrps/select2.min.js') }}"></script>
    ...
    <script src="{{asset('dist-assets/js/scripts/dashboard.v3.script.min.js')}}"></script>
    <script src="{{asset('dist-assets/js/scripts/apexcharts.min.js')}}"></script>
    <script src="{{asset('dist-assets/js/scripts/card.metrics.script.min.js')}}"></script>
    <script src="{{asset('dist-assets/js/scripts/widgets-statistics.min.js')}}"></script>
    <script src="{{asset('dist-assets/js/scripts/apexColumnChart.script.min.js')}}"></script>
