...
<h1 class="text-center">Liste des Offre Services  </h1>
    <div class="row">
       <div class="col-md">
          ...
          <a href="{{route('service.create')}}" class="dropdown-item" ><i class="fas fa-plus"></i> Ajouter Service </a>
           </div>
               </div>
               </div>
               <div class="card-body">
                 ...
                 <a  href="{{route('service.edit',$item->id )}}" class="btn btn-success btn-sm m-1" type="submit" title="modifier"> <i class="fas fa-edit"></i> </a>
