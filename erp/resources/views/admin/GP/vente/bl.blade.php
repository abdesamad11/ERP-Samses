            ...
            <main>
                ...
                <div class="row contacts">
                    ...
                    <div class="col invoice-to">
                        <div class="text-gray-light">Bon de Livraison :</div>
                    ...
                    @foreach ($bl as $item)
                        <div class="col invoice-details">
                            <h1 class="invoice-id">Ref BL Numero :  {{$item->num_bl}} </h1>
                            <?php
                            ...
                            <div class="date">Date  : {{$item->date_v}} </div>
                ...
                <table border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tbody>
                       @foreach ($venteProd as $item)

                       <tr>
                        <td class="no">{{$item->reference_prod}}</td>
