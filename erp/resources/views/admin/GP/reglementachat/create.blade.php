...
<div class="breadcrumb">
    <h1>GP ET GS </h1>
    <ul>
        <li><a href="#">Reglement Achats </a></li>
        <li>Reglement N : {{ $item->no_commande   }}  </li>
...
<div class="separator-breadcrumb border-top"></div>
                <div class="row">
                    <div class="col-md-12">
                        ...
                        @if ($errors->any())
                         ...
                         @endif
                <div class="card-title mb-3">{{$item->no_commande}} </div>
                <form method="POST" action="{{route('reglementachat.store')}}" enctype="multipart/form-data">
                    @csrf
                 <div class="row">
            ...
            <input type="hidden" name="achat_id" value="{{$item->no_commande}}">
            ...
            <div class="col-md-3 form-group mb-3">
                <label > Numero :</label>
                <input class="form-control"  type="text" name="numero" placeholder="R-000" />
            </div>
