...
<div class="separator-breadcrumb border-top"></div>
                <div class="row">
                    <div class="col-md-12">
                        ...
                        @if ($errors->any())
                         ...
                         @endif
                <div class="card-title mb-3"> Ajouter Nouveau  Fournisseurs </div>
        ...
        <div class="col-md-6 form-group mb-3">
             ...
             <input class="form-control"  name="nom_f" type="text"  placeholder="name fornisseurs"/>
        </div>
        <div class="col-md-6 form-group mb-3">
        ...
        <div class="col-md-6 form-group mb-3">
            ...
            <input class="form-control" id="credit1"  name="adresse_f"  type="text" placeholder="Adresse"/>
        </div>
      <div class="col-md-6 form-group mb-3">
            <img src="#" alt=""  id="imge">
