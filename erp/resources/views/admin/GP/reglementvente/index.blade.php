...
@section('content')
<h1 class="text-center">Liste des Reglememnt Clients </h1>
<div class="row">
    <div class="col-md">
        <div class="card o-hidden mb-4">
            <div class="card-header d-flex align-item-s-center">
                <h3 class="w-50 float-left card-title m-0">Liste Paimenet  Regler Vente  </h3>
                    ...
                    <table class="table dataTable-collapse" id="user_table" >
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$item->remarque}}</td>
                                <td>{{$item->Montant}}.00 DH</td>
                                <td>{{$item->nrest}}.00 DH</td>
                                <td>

             <form method="POST"  action="{{route('reglementvente.destroy',$item->id)}}">
                @csrf
                @method('DELETE')
