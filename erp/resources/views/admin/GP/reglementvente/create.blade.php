...
<div class="breadcrumb">
    <h1>GP ET GS </h1>
    <ul>
        <li><a href="#">Reglement Ventes </a></li>
        <li>Reglement N : {{$item->id}}  </li>
...
<div class="separator-breadcrumb border-top"></div>
                ...
                <form method="POST" action="{{route('reglementvente.store')}}" enctype="multipart/form-data">
                    @csrf
                 <div class="row">
            ...
            <input type="hidden" name="vente_id" value="{{$item->id}}">
