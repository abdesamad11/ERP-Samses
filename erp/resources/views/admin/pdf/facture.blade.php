...
<body>
		...
		<div class="container">
			<div class="table-wrapper">
				<table>
					...
					<th class="desc"><div>Cause</div></th>
					<th class="qty"><div> Date </div></th>
					<th class="unit"><div>nombre de jours par année restant </div></th>
					<th class="total"><div>nombre de jours de votre conger  </div></th>
						</tr>
					</tbody>
					<tbody class="body">
						<tr>
				...
				<table class="grand-total">
					<tbody>
						<tr>
							...
							<td class="desc"></td>
							<td class="qty"></td>
							<td class="unit">Signature du collaborateur</td>
							<td class="total">-----------------------------</td>
						</tr>
						<tr>
							<td class="no"></td>
							<td class="desc"></td>
							<td class="qty"></td>
							<td class="unit">Signature du responsable hiérarchique</td>
							<td class="total">----------------------------------</td>
						</tr>
	...
	<footer>
		<div class="container">
			...
			<div class="end">Cette attestion a une seule copie </div>
		</div>
	</footer>
