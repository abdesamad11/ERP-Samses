                ...
                <div class="row contacts">
                    ...
                    @foreach ($cod as $item)
                        <div class="col invoice-details">
                            <h1 class="invoice-id">Ref : F-{{$item->num_f}} </h1>
                            <?php
                            ...
                            <div class="date">Date Facturation  : {{$item->date_ser}} </div>
                            <div class="date">Date d'expire  : {{$item->date_exp}} </div>
                            <div class="date">Objet :Facturation Services </div>
                        </div>
                ...
                @foreach ($venteService as $item)
                    ...
                    <tfoot>
                        ...
                        <tr>
                            <td></td>
                            <td>TVA (20%) </td>
                            <td>{{$total*0.2}}.00 DH</td>
                        </tr>
                        <tr>
                            <td></td>
                            <td>Global TOTAL</td>
                            <td>{{$total*0.2+$total}}.00 DH</td>
                        </tr>
