    ...
    <div class="col-md">
        <div class="card o-hidden mb-4">
            <div class="card-header d-flex align-item-s-center">
                <h3 class="w-50 float-left card-title m-0">Liste Paimenet  Regler Service   </h3>
       ...
       <a href="{{route('reglement.create')}}" class="dropdown-item" ><i class="fas fa-plus"></i> Ajouter Reglement  </a>
        </div>
            </div>
            </div>
            <div class="card-body">
