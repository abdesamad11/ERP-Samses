    ...
    <div class="col-md">
        <div class="card o-hidden mb-4">
            <div class="card-header d-flex align-items-center">
                <h3 class="w-50 float-left card-title m-0">Ajouter  Nouveau Devis</h3>
       ...
       <a href="{{route('devis.create')}}" class="dropdown-item" ><i class="fas fa-plus"></i>
        Ajouter Devis  </a>
        </div>
            </div>
            </div>
