...
<div class="separator-breadcrumb border-top"></div>
                ...
                <div class="card-body">
                        @if ($errors->any())
                            ...
                            <br/>
                        @endif
                <div class="card-title mb-3">Nouveaux Consultation </div>
            <form method="POST" action="{{route('vserv.store')}}" enctype="multipart/form-data">
                     @csrf
                 <div class="row">
                ...
                <input class="form-control" id="" placeholder="2020/02/02 "  name="date_ser" type="date"/>
                 </div>
                 <div class="col-md-2 form-group mb-3">
                    <label for=""></label>
